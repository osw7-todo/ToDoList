    ...
    return (
        <SafeAreaView style={viewStyles.container}>
            ...
            <View style={topbarStyles.topbar}>
                <IconButton type={images.menubar} style={{alignItems:'flex-start'}}/>
                <Text style={[textStyles.title, {alignItems:'center'}]}> {month}/{date} </Text>
                <Text style={[textStyles.title, {alignItems:'flex-end'}]}> today </Text>
            </View>
